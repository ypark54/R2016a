...
char  *gblMatSignalLoggingFilename = NULL;
...
void rt_WriteSimMetadata(const char *file, const SimStruct* S)
{
    ...
    *(mxGetPr(mxDoubleVar)) = ssGetT(S); 
    ...
    mxLogicalVar = mxCreateLogicalScalar(ssIsVariableStepSolver(S));
    ...
    *((uint32_T*)mxGetData(mxUint32Var)) = ssGetChecksum3(S);
    ...
    mxLogicalVar = mxCreateLogicalScalar(ssGetStopRequested(S));
