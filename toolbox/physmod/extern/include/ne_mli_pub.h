/*
 * @(#)ne_mli_pub.h    generated by: makeheader 5.1.5  Mon Dec 28 12:37:36 2015
 *
 ...
 *				../mw/basictypes.h
 *				../mw/equationdomain.h
 *				nem_authoring/nem_cgexternalfunctions.cpp
 *				nem_authoring/nem_customequationdatamanager.cpp
 *				nem_authoring/nem_customequationentryinfo.cpp
 *				nem_authoring/nem_customequationgroupirbuilder.cpp
 *				nem_authoring/nem_customequationmanager.cpp
 *				nem_authoring/nem_customfunctiondatamanager.cpp
 *				nem_authoring/nem_emitterrec.cpp
 *				nem_authoring/nem_eqncapi.cpp
 *				nem_authoring/nem_equationfunction.cpp
 *				nem_authoring/nem_equationmanagercommon.cpp
 *				nem_authoring/nem_equationmanagerregister.cpp
 *				nem_authoring/nem_externalfunctionscommon.cpp
 *				nem_authoring/nem_extraction.cpp
 *				nem_authoring/nem_functionargumentinfo.cpp
 *				nem_authoring/nem_functionarguments.cpp
 *				nem_authoring/nem_functiondelayinfo.cpp
 *				nem_authoring/nem_functionequationinfo.cpp
 *				nem_authoring/nem_functionmodeinfo.cpp
 *				nem_authoring/nem_functionparameterinfo.cpp
 *				nem_authoring/nem_functionstarttimeinfo.cpp
 *				nem_authoring/nem_functiontimeinfo.cpp
 *				nem_authoring/nem_functionvariableinfo.cpp
 *				nem_authoring/nem_imeexternalfunctions.cpp
 *				nem_authoring/nem_irsource.cpp
 *				nem_authoring/nem_irsourcecommon.cpp
 *				nem_authoring/nem_makematlabname.cpp
 *				nem_authoring/nem_matrixudc.cpp
 *				nem_authoring/nem_mlequationgroupirbuilder.cpp
 *				nem_authoring/nem_mlequationmanager.cpp
 *				nem_authoring/nem_mlfunctionarguments.cpp
 *				nem_authoring/nem_mlirsource.cpp
 *				nem_authoring/nem_neirinfo.cpp
 *				nem_authoring/nem_setupderivativemethodir.cpp
 *				nem_authoring/nem_setupeqndatarec.cpp
 *				nem_authoring/nem_setupfunctionmethodir.cpp
 *				nem_authoring/nem_setuplinearmethodir.cpp
 *				nem_authoring/nem_setupmassmatrixmethodir.cpp
 *				nem_authoring/nem_setupmethodir.cpp
 *				nem_authoring/nem_setupmodalvariabilitymethodir.cpp
 *				nem_authoring/nem_setupsparsederivativemethodir.cpp
 *				nem_authoring/nem_setupsparsederivativepatternmethodir.cpp
 *				nem_authoring/nem_setupsparsetotalpatternmethodir.cpp
 *				nem_authoring/nem_sscequationmanager.cpp
 *				nem_authoring/nem_sscfunctionarguments.cpp
 *				nem_authoring/nem_sscirsource.cpp
 *				nem_builtins/nem_builtins_reg.cpp
 *				nem_cg/nem_cgparamsudc.cpp
 *				nem_cg/nem_cgprinter.cpp
 *				nem_cg/nem_cgsupport.cpp
 *				nem_cg/nem_customequationdatamanagerimpl.cpp
 *				nem_cg/nem_customfunctiondatamanagerimpl.cpp
 *				nem_cg/nem_dsircg.cpp
 *				nem_cg/nem_dsircompiler.cpp
 *				nem_cg/nem_dsirime.cpp
 *				nem_cg/nem_efutil.cpp
 *				nem_cg/nem_methodargumentinfo.cpp
 *				nem_cg/nem_methodoutputirinfoimpl.cpp
 *				nem_cg/nem_systeminputargumentinfo.cpp
 *				nem_cg/nem_systeminputirinfoimpl.cpp
 *				nem_cg/nem_tupletypemetadata.cpp
 ...
 *				nem_construction/nem_createdynamicsystem.cpp
 *				nem_construction/nem_customequationinfo.cpp
 *				nem_construction/nem_customequationinfoudc.cpp
 ...
 *				nem_construction/nem_networkregistry.cpp
 *				nem_construction/nem_networkudc.cpp
 ...
 *				nem_construction/nem_solvermodeudc.cpp
 *				nem_construction/nem_solvervariableudc.cpp
...
EXTERN_C NeEquationGroup *ne_builder_add_group(NeLibraryElementBuilder *builderPtr);


EXTERN_C void ne_eqn_group_set_setup_cleanup_fcn(NeEquationGroup *groupPtr,
                                        NeEqSetupFcn     setupFcn,
                                        NeEqCleanupFcn   cleanupFcn);


EXTERN_C void ne_eqn_group_set_zc_ranges(NeEquationGroup  *groupPtr,
                                const NeRange    *ranges_,
                                const size_t      ranges_size,
                                const NeZCData   *zcData_,
                                const size_t      zcDataSize);


EXTERN_C void ne_eqn_group_set_zc_types(NeEquationGroup  *groupPtr,
                               const NeZCData   *zcData,
                               const size_t      zcDataSize);


EXTERN_C void ne_eqn_group_set_assert_info(NeEquationGroup  *groupPtr,
                                  const NeRange    *ranges_,
                                  const size_t      ranges_size,
                                  const NeAssertData   *assertData_,
                                  const size_t      assertDataSize);


EXTERN_C void ne_eqn_group_set_method(NeEquationGroup    *groupPtr,
                             NeEqGroupMethodId   methodId,
                             NeEqMethod          method);


EXTERN_C void ne_eqn_group_set_method_size(NeEquationGroup   *groupPtr,
                                  NeEqGroupMethodId  methodId,
                                  size_t             size);


EXTERN_C NeEquation *ne_eqn_group_add_equation(NeEquationGroup *groupPtr);


EXTERN_C void ne_eqn_set_switched_linear(NeEquation *eqnPtr, int32_T isSwitchedLinear);


EXTERN_C void ne_eqn_set_unit(NeEquation *eqnPtr, const unit_manager::UnitExpression &unit);


EXTERN_C void ne_eqn_add_range(NeEquation *eqnPtr, const NeRange* ranges, const size_t i);


EXTERN_C void ne_eqn_set_param_method(NeEquation         *eqnPtr,
                             NeEqParamMethodId   methodId,
                             NeEqParamMethod     method);


EXTERN_C void ne_eqn_set_method(NeEquation   *eqnPtr,
                       NeEqMethodId  methodId,
                       NeEqMethod    method);


EXTERN_C size_t ne_eqn_get_parameter_length(const NeElementEquationGroupInfo *eqnInfoPtr, 
                                   const char                       *parameterName);


EXTERN_C const void* ne_eqn_get_parameter( const NeElementEquationGroupInfo* eqnInfoPtr,
