...
PmIntVector mASSERT; PmIntVector mPASSERT; PmRealVector mDEL_T; PmRealVector
...
mOBS_EXP; PmRealVector mOBS_ACT; PmRealVector mOBS_ALL; PmIntVector mDP_L;
PmIntVector mDP_I; PmIntVector mDP_J; PmRealVector mDP_R; PmRealVector mQX;
...
NeDsMethodOutput; typedef enum NeDsMethodIdTag { NE_INVALID_METHOD_ID = -1,
NE_DS_METHOD_M_P, NE_DS_METHOD_M, NE_DS_METHOD_VMM, NE_DS_METHOD_DXM_P,
NE_DS_METHOD_DXM, NE_DS_METHOD_DUM_P, NE_DS_METHOD_DUM, NE_DS_METHOD_DTM_P,
NE_DS_METHOD_DTM, NE_DS_METHOD_A_P, NE_DS_METHOD_A, NE_DS_METHOD_B_P,
NE_DS_METHOD_B, NE_DS_METHOD_C_P, NE_DS_METHOD_C, NE_DS_METHOD_F,
NE_DS_METHOD_VMF, NE_DS_METHOD_SLF, NE_DS_METHOD_DXF_P, NE_DS_METHOD_DXF,
NE_DS_METHOD_DUF_P, NE_DS_METHOD_DUF, NE_DS_METHOD_DTF_P, NE_DS_METHOD_DTF,
NE_DS_METHOD_DDF_P, NE_DS_METHOD_DDF, NE_DS_METHOD_TDUF_P, NE_DS_METHOD_TDXF_P,
NE_DS_METHOD_IC, NE_DS_METHOD_ICR, NE_DS_METHOD_ICR_IM, NE_DS_METHOD_ICR_ID,
NE_DS_METHOD_DXICR, NE_DS_METHOD_DXICR_P, NE_DS_METHOD_TDUICR_P,
...
NE_DS_METHOD_MODE, NE_DS_METHOD_ZC, NE_DS_METHOD_CACHE, NE_DS_METHOD_UPDATE_R,
...
NE_DS_METHOD_Q1_P, NE_NUM_METHODS } NeDsMethodId; typedef int32_T
(*NeDsMethod)(const NeDynamicSystem *, const NeDynamicSystemInput *,
...
size_t mNumCache; size_t mNumObservables; size_t mNumObservableElements; size_t
mNumZcs; size_t mNumAsserts; size_t mNumAssertRanges; size_t mNumParamAsserts;
size_t mNumParamAssertRanges; size_t mNumRanges; size_t mNumEquationRanges;
size_t mNumFundamentalSamples; size_t mNumDelays; size_t mNumLogicalParameters;
size_t mNumIntegerParameters; size_t mNumIndexParameters; size_t
mNumRealParameters; size_t mNumLogicalDerivedParameters; size_t
