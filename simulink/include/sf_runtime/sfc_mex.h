...
LIBMWSF_RUNTIME_API void sf_jit_set_error_flag(void);
...
LIBMWSF_RUNTIME_API int       ssIsMessageQueueFull_wrapper(SimStruct *S, ssMessageQueueLocationType queueType, int portIdx, int isOutputPort);
