...
LIBMWSF_RUNTIME_API void sf_debug_report_state_inconsistency_error(struct SfDebugInstanceStruct* debugInstance, unsigned int machineNumber, unsigned int chartNumber, unsigned int instanceNumber,
                                                                   unsigned int sfDebugObjectTypeEnum,
                                                                   unsigned int objectNumber,
                                                                   int activeEventNumber,
                                                                   double simulationTime,
                                                                   bool isFasterRuntimeOn);
