...
# define SS_CALL_MDL_FINALIZE                         151
#endif
...
struct _ssMdlInfo {
  ...
  struct {
      ...
      unsigned int reserved15            :12;/* remainder are reserved      */
  } mdlFlags;
...
typedef void (*mdlFinalizeFcn)(SimStruct *S);
...
struct _ssSFcnModelMethods4 {
    ...
    mdlFinalizeFcn mdlFinalize;

    void  *reservedForFuture[13];
};
...
#define ssGetmdlFinalize(S) \
    ((S)->states.modelMethods2->modelMethods4->mdlFinalize)
#define ssSetmdlFinalize(S,finalize) \
    ((S)->states.modelMethods2->modelMethods4->mdlFinalize = (finalize))
#define sfcnFinalize(S) \
    ((*(S)->states.modelMethods2->modelMethods4->mdlFinalize)(S))
