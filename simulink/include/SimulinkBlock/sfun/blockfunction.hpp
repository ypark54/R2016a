...
namespace RTW
{
    ...
    extern "C"
    {
        ...
        static inline int call_cgInitializeOnce(CodeConstructor* pCodeCtor)
        {
            Block* pBlock = static_cast<Block*>(pCodeCtor);
            return call_Block_method(pBlock, &Block::cgInitializeOnce);
        }
        ...
        static inline int call_cgFinalize(CodeConstructor* pCodeCtor)
        {
            Block* pBlock = static_cast<Block*>(pCodeCtor);
            return call_Block_method(pBlock, &Block::cgFinalize);
        }
        ...
        SL_CORE_BLOCK_EXPORT_CLASS void SFun_set_cgInitializeOnce (SFun_BlockFunctionTable* pFcnTable, SFun_BlockFunction pfn_call_cgInitializeOnce );
        ...
        SL_CORE_BLOCK_EXPORT_CLASS void SFun_set_cgFinalize       (SFun_BlockFunctionTable* pFcnTable, SFun_BlockFunction pfn_call_cgFinalize       );
    ...
    SFun_BlockFunctionTable_SmartPtr build_BlockFunctionTable(DerivedBlock* = NULL)
    {
        ...
        SFun_set_cgInitializeOnce ( pFcnTable.get(), &call_cgInitializeOnce  );
        ...
        SFun_set_cgFinalize     ( pFcnTable.get(), &call_cgFinalize      );
